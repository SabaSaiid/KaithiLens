...
const KEYBOARD_GROUPS = [
  ...
  },
  {
    ...
    keys: [
      ...
      { char: "𑂛", deva: "ढ", name: "DDHA", phonetic: "dh" },
      { char: "𑂚", deva: "ड़", name: "DDDHA/RRA", phonetic: "r" },
      { char: "𑂜", deva: "ढ़", name: "RHA", phonetic: "rh" },
      { char: "𑂝", deva: "ण", name: "NNA", phonetic: "n" },
      { char: "𑂞", deva: "त", name: "TA", phonetic: "t" },
      { char: "𑂟", deva: "थ", name: "THA", phonetic: "th" },
      { char: "𑂠", deva: "द", name: "DA", phonetic: "d" },
      { char: "𑂡", deva: "ध", name: "DHA", phonetic: "dh" },
      { char: "𑂢", deva: "न", name: "NA", phonetic: "n" },
      { char: "𑂣", deva: "प", name: "PA", phonetic: "p" },
      { char: "𑂤", deva: "फ", name: "PHA", phonetic: "ph" },
      { char: "𑂥", deva: "ब", name: "BA", phonetic: "b" },
      { char: "𑂦", deva: "भ", name: "BHA", phonetic: "bh" },
      { char: "𑂧", deva: "म", name: "MA", phonetic: "m" },
      { char: "𑂨", deva: "य", name: "YA", phonetic: "y" },
      { char: "𑂩", deva: "र", name: "RA", phonetic: "r" },
      { char: "𑂪", deva: "ल", name: "LA", phonetic: "l" },
      { char: "𑂫", deva: "व", name: "VA", phonetic: "v" },
      { char: "𑂬", deva: "श", name: "SHA", phonetic: "sh" },
      { char: "𑂭", deva: "ष", name: "SSA", phonetic: "sh" },
      { char: "𑂮", deva: "स", name: "SA", phonetic: "s" },
      { char: "𑂯", deva: "ह", name: "HA", phonetic: "h" },
    ]
  },
  {
    category: "Matras & Signs (मात्रा एवं चिह्न)",
    keys: [
      { char: "𑂰", deva: "ा", name: "AA", phonetic: "aa" },
      { char: "𑂱", deva: "ि", name: "I", phonetic: "i" },
      { char: "𑂲", deva: "ी", name: "II", phonetic: "ii" },
      { char: "𑂳", deva: "ु", name: "U", phonetic: "u" },
      { char: "𑂴", deva: "ू", name: "UU", phonetic: "uu" },
      { char: "𑂵", deva: "े", name: "E", phonetic: "e" },
      { char: "𑂶", deva: "ै", name: "AI", phonetic: "ai" },
      { char: "𑂷", deva: "ो", name: "O", phonetic: "o" },
      { char: "𑂸", deva: "ौ", name: "AU", phonetic: "au" },
      { char: "𑃂", deva: "ृ", name: "VOCALIC R", phonetic: "ri" },
      { char: "𑂹", deva: "्", name: "VIRAMA", phonetic: "halant" },
      { char: "𑂺", deva: "़", name: "NUKTA", phonetic: "dot" },
      ...
      { char: "𑂾", deva: "।", name: "DANDA ALIAS", phonetic: "." },
      { char: "𑂻", deva: "॰", name: "ABBR", phonetic: "o" },
    ]
  }
];
